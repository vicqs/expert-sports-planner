export const SESSION_TYPES = {
    DRO: { code: 'DRO', name: 'Desarrollo', description: 'Sesiones principales de carga' },
    COM: { code: 'COM', name: 'Compensación', description: 'Recuperación activa, trabajo suave' },
    REC: { code: 'REC', name: 'Recuperación', description: 'Sesiones muy ligeras' },
    DES: { code: 'DES', name: 'Descanso', description: 'Sin actividad' },
    CPT: { code: 'CPT', name: 'Competencia', description: 'Día de carrera oficial' },
    EVA: { code: 'EVA', name: 'Evaluación', description: 'Test o prueba de rendimiento' },
    MAN: { code: 'MAN', name: 'Mantenimiento', description: 'Sostener nivel actual' },
};
