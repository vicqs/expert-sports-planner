            ...
            <div className="slots-container">
                {slots.length === 0 ? (
                    <div className="empty-state">
                        ...
                        <Button variant="primary" size="sm" onClick={handleAddSlot} leftIcon={<Plus size={16} />}>
                    ...
                    <div className="slots-list">
                                ...
                                <div className="slot-form">
                                    ...
                                    <div className="form-group">
                                        ...
                                        <input
                                            type="number"
                                            value={slot.capacity}
                                            onChange={(e) => handleUpdateSlot(slot.id, 'capacity', parseInt(e.target.value))}
                                            min="1"
                                        />
                                    </div>
                                </div>
                        ...
                        <div className="actions-row">
                            <Button variant="secondary" onClick={handleAddSlot} leftIcon={<Plus size={16} />}>
                                Agregar Bloque
                            </Button>
