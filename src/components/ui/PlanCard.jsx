...
import { Card, Button, ProgressRing } from './index';
        ...
        <Card hover glass className="plan-card" onClick={onClick}>
            <div className="plan-card-header">
                ...
                <div className="plan-status">
                    ...
                    {isCompleted && <span className="badge badge-secondary">Completado</span>}
                </div>
            </div>
            ...
            <div className="plan-card-footer">
                ...
                <Button variant="ghost" size="sm" rightIcon={<ChevronRight size={16} />} onClick={(e) => {
                    e.stopPropagation();
                    onClick();
                }}>
                    Ver Plan
